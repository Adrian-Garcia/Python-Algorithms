...
class Persona:
    ...
    def presentacion(self):
        print(
            "Mi nombre es {} {} tengo {} años".format(
...
class Estudiante(Persona):
    ...
    def presentacion(self):
        print(
            "Mi nombre es {} {} tengo {} anios y estudio {}".format(
                self.nombre, self.apellido, self.edad, self.carrera
            )
        )
...
class Escuela:
    ...
    def descripcion(self):
        ...
        print(
            "El {} se encuentra en {}. Ocupa el lugar {} nacional".format(
                self.nombre, self.estado, self.ranking
            )
        )
...
class Fraccion:
    ...
    def __mul__(self, fracc):
        return Fraccion(
            self.numerador * fracc.numerador, self.denominador * fracc.denominador
        )
...
# Polimorfismo
TecIngenieria = EscuelaIngenieria("Adrian", "Garcia", 20, "ITC", ["Intro", "Mate"])
