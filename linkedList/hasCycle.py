...
class Solution:
    def hasCycle(self, head: ListNode) -> bool:
        """
        Simple set solution. Fast but uses lots of memory. Beats 79.38% in runtime but only 7.69% in memory
        """
        visited = set()
        curr = head
    ...
    def hasCycle1(self, head: ListNode) -> bool:
        """
        Tortoise and Herr algorythm

        Uses constant memory but fails in a specific case
