...
class numpyTest(object):
    ...
    def arraySlicing(self):
        ...
        print(
            "Values of arr from start of indec to 4 (not included 4) = {}".format(
                arr[:4]
            )
        )
        print(
            "Values of arr from the end to index 1 from the end = {}".format(arr[-3:-1])
        )
        ...
        print(
            "Values of arr2, first and second row, index 2  = {}".format(arr2[0:2, 2])
        )
        print(
            "Values of arr2, first and second row, index 1 to 4  = {}".format(
                arr2[0:2, 1:4]
            )
        )
