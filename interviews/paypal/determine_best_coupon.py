...
def get_bests_order_coupons(coupons):
    ...
    for coupon in coupons:
        if coupon["discountType"] == "PERCENT_OFF_ORDER"  and coupon["discountAmount"] > best_percentage:
            best_percentage = coupon["discountAmount"]
            best_percentage_code = coupon["code"]
            
        elif coupon["discountType"] == "DOLLARS_OFF_ORDER" and coupon["discountAmount"] > best_dollars:
